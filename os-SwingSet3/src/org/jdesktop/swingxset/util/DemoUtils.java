...
public class DemoUtils {
    ...
    /**
     * Checks whether the system property can be written.
     * 
     * @param property
     * @return
     */
    public static boolean canWriteProperty(String property) {
        SecurityManager manager = System.getSecurityManager();
        if (manager == null) return true;
        try {
            manager.checkPermission(new PropertyPermission(property, 
                    "write"));
            return true;
        } catch (SecurityException e) {
            // nothing to do, not allowed to write
        }
        return false;
    }
