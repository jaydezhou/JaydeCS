/*
 * $Id: DisplayValues.java 1299 2013-03-06 13:38:20Z kleopatra $
 *
...
public class DisplayValues {
    ...
    public static class MappedStringValue implements StringValue {

        private Map<Object, String> map;
        public MappedStringValue(Map<Object, String> map) {
            this.map = map;
        }
        @Override
        public String getString(Object arg0) {
            String text = map.get(arg0);
            if (text != null) {
                return text;
            }
            return StringValues.TO_STRING.getString(arg0);
        }
