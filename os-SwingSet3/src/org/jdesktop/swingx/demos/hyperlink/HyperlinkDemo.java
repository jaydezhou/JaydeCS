/*
 * $Id: HyperlinkDemo.java 1300 2013-03-28 12:25:18Z kleopatra $
 *
...
public class HyperlinkDemo extends JPanel {
    ...
    private void bind() throws URISyntaxException {
        ...
        plainBrowse.setURI(new URI("http://swingx.java.net"));
        // default mailer action, text defaults to uri
        plainMail.setURI(new URI("mailto:nobody@java.net"));
